    ...
    return (
        <div>
            ...
            <div className='relative '>
                ...
                <div className={`text-[40px] md:text-[60px] italic font-medium absolute text-white top-[132px] text-center w-full `}>01-J-02</div>
            ...
            <div className='px-3.5'>
                ...
                <div class="relative  w-full h-[auto] justify-center mb-20  " id='skills'>
                    ...
                    <div className="mt-20 pb-10">
                        ...
                        出産育児やキャリア移行期には、社会実験参画やフリーランス事業、言語キャッチアップなどデザインやコードへの行動を継続。コロナを期にブレイクを終了し、キャリアを再構築。</p>
                        <div >
