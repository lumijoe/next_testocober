...
<div className='flex flex-col justify-center relative mb-8 mr-8'>
                            ...
                            <div className='h-auto w-[291px] bg-white' style={{ boxShadow: '0px 3px 6px rgba(0, 0, 0, 0.1)', borderRadius: '4px', overflow: 'hidden', position: 'relative' }}>
                                <CommonImgTmb 
                                src="/workWebTmb01.png"
                                alt="Image"
                                width={291}
                                height={196}
                                priority
